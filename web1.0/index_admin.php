...
<section id="services" class="services service-section">
  ...
  <div class="section-header">
                ...
                <p class="wow fadeInDown animated">The information below shows the latest record.</p>
            </div>
    <div class="row">
...
?>
		  <p><form method = "post" action = "Allery_show.php"><input type="submit" name="" class="submitBnt" value = "ReadMore"/></form></p>
        </div>
      </div>
...
?>
          ...
          <p><form method = "post" action = "prescript_show.php"><input type="submit" name="" class="submitBnt" value = "Read More"/></form></p>		
        </div>
      </div>
	  ...
	  <div class="col-md-4 col-sm-6 services text-center"> <span class="icon icon-scope"></span>
        <div class="services-content">
          <h5>Medication</h5>
          <p><form method = "post" action = "Medicatinsert.php"><input type="submit" class="submitBnt" name="" value = "Read More"/></form></p>		
        </div>
      </div>
	  <div class="col-md-4 col-sm-6 services text-center"> <span class="icon icon-scope"></span>
        <div class="services-content">
          <h5>Diagnose</h5>
          <p><form method = "post" action = "Allergy.php"><input type="submit" name="" class="submitBnt" value = "Read More"/></form></p>		
        </div>
      </div>
	  <div class="col-md-4 col-sm-6 services text-center"> <span class="icon icon-scope"></span>
        <div class="services-content">
          <h5>Encounter</h5>
          <p><form method = "post" action = "encounter_show.php"><input type="submit" name="" class="submitBnt" value = "Read More"/></form></p>		
        </div>
      </div>
	  <div class="col-md-4 col-sm-6 services text-center"> <span class="icon icon-scope"></span>
        <div class="services-content">
          <h5>Appointment</h5>
          <p><form method = "post" action = "Allergy.php"><input type="submit" name="" class="submitBnt" value = "ReadMore"/></form></p>		
        </div>
      </div>
	 <div class="col-md-4 col-sm-6 services text-center"> <span class="icon icon-scope"></span>
        <div class="services-content">
	...
	<div class="col-md-4 col-sm-6 services text-center"> <span class="icon icon-document"></span>
        <div class="services-content">
          <h5>Flowsheet</h5>
          <li><a href= "Vitals_show.php">Vitals</a></li>	
		  <li><a href= "lab_show.php">QuestLab</a></li>	
...
_END;
  ...
  $result4->close();	
?>
	<p><form method = "post" action = "Smokeinsert.php"><input type="submit" name="" class="submitBnt" value = "Read More"/></form></p>
        </div>
      </div>
    </div>
  </div>
