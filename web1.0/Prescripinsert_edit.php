  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2 conForm">   
		...
		<table>
		<th> <h2 class="wow fadeInDown animated" >Prescription</h2></th>
        <tr><td> <label for="type">Despense:</label> <?php echo $despense?></td>
            <td><input type="hidden" name="despense" value="<?php echo $despense?>"></td></tr>
        
       
        
        <tr><td><label for="refills">Refills:</label> <?php echo $refills?></td>
           <td><input type="hidden" name="refills" value="<?php echo $refills?>" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            </td></tr>
        <tr></tr>
        <tr><td><label for="days_supply">Days of Supply:</label><?php echo $days?></td>
           <td><input type="hidden" name="days_supply" value="<?php echo $days?>"class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            </td></tr>
		
        
        <tr><td><label for="scriptdate">Date of Script:</label><?php echo $scriptdate?></td>
           <td><input type="hidden" name="scriptdate" value="<?php echo $scriptdate?>" class=""/></td></tr>
        
        <tr><td><label for="pharmacy">Pharmacy:</label><?php echo $pharmacy?></td>
           <td><input type="hidden" name="pharmacy" value="<?php echo $pharmacy?>" class=""/></td></tr>
        
        <tr><td><label for="pre_provider">Prescription Provider:</label><?php echo $provider?></td>
           <td><input type="hidden" name="pre_provider" value="<?php echo $provider?>" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<form method="POST" action="Prescriptinsert_pre.php">
