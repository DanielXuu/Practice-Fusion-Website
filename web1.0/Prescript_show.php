...
<section id="insert" class="section">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2 conForm">   
		...
		<tr><td><label for="type">ID:</label></td>
			<td><label for="type">Despense:</label></td>  
			<td><label for="refills">Refills:</label></td>
			<td><label for="days_supply">Days of Supply:</lable></td> 
            <td><label for="scriptdate">Date of Script:</label> </td>
            <td><label for="pharmacy">Pharmacy:</label></td>
            <td><label for="pre_provider">Prescription Provider:</label></td>
           
     <?php
 
 
  $pid =$_SESSION['pid'];
  $query = "SELECT * FROM prescription p WHERE p.P_id=$pid";
  ...
  echo <<<_END
		  ...
		  <tr>
				<td height=30 width= 80>$row[0]</td>
