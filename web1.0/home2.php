...
<section id="services" class="services service-section">
  ...
  $birth=$_POST['birthdate'];
   ...
   if($birth){
		$query = "SELECT * FROM patient p JOIN demographic d on p.p_id = d.p_id where where p.birth_date='$birth'";
   }
   if($name && $birth){
	   $query = "SELECT * FROM patient p JOIN demographic d on p.p_id = d.p_id where where  p.birth_date='$birth' and p_firstname LIKE '%$_POST[firstname]%'";
   }
  ...
  echo <<<_END
		  ...
		  <tr>
				<tr><form method = "post" action = "session.php">
