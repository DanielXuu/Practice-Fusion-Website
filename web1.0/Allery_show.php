    ...
    <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2 conForm">   
		...
		<tr><td><label for="id"> ID:</label></td>   
			<td><label for="name"> Allergy Name:</label></td>    
			<td><label>Allergies Type:</label></td>
            <td><label for ="sever">Severity:<label></td>
            <td><label for="onset">Onset:</label></td>
			<td><label for="reaction">Reaction:</label></td> 
			<td><label for="status">Status:</label></td>
			<td><label for="comment">Comments:</label></td></tr>
           
     <?php
 
 
 $pid =$_SESSION['pid'];
  $query = "SELECT * FROM allergies a WHERE a.P_id=$pid ";
